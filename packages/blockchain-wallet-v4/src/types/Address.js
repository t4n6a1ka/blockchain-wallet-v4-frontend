...
export const encrypt = curry((securityModule, secondPassword, address) => {
...
export const decrypt = curry((securityModule, secondPassword, address) => {
  const decipher = returnTask(
    curry(securityModule.decryptWithSecondPassword)({ secondPassword })
  )
